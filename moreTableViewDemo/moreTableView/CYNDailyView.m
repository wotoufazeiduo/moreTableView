...
@interface CYNDailyView ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, assign) CGPoint lastContentOffset;

@end

@implementation CYNDailyView
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text =[NSString stringWithFormat:@"测试第%ld行日报数据",indexPath.row];
    return cell;
}
