...
@interface CYNWeeklyView ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic, assign) CGPoint lastContentOffset;
@end



@implementation CYNWeeklyView
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text =[NSString stringWithFormat:@"测试第%ld行周报数据",indexPath.row];
    return cell;
}
